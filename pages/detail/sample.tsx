...
const SampleDetail = () => {
  ...
  const image = "/api/proxy?url=http://69.10.55.2/images/cosmicsignature/sample.png";
  const video = "/api/proxy?url=http://69.10.55.2/images/cosmicsignature/sample.mp4";
...
export async function getServerSideProps() {
  ...
  const imageUrl = "/api/proxy?url=http://69.10.55.2/images/cosmicsignature/sample.png";
